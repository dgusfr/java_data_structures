...
- [Matrizes em Java](#matrizes-em-java)
  - [1. O que é uma Matriz?](#1-o-que-é-uma-matriz)
  - [2. Declaração e Instanciação de Matrizes em Java](#2-declaração-e-instanciação-de-matrizes-em-java)
  - [3. Acesso aos Elementos](#3-acesso-aos-elementos)
  - [4. Como Percorrer uma Matriz](#4-como-percorrer-uma-matriz)
  - [5. Propriedade `length`](#5-propriedade-length)
  - [6. Exemplo Completo](#6-exemplo-completo)
  - [7. Vantagens e Desvantagens das Matrizes](#7-vantagens-e-desvantagens-das-matrizes)
  - [8. Quando usar matrizes?](#8-quando-usar-matrizes)
